...
To protect internal implementation details and reduce payload size:

- **Hiding Identifiers:** Internal Cloudinary identifiers (`imagePublicId`, `logoPublicId`) are explicitly excluded from all public API responses. Clients only receive the rendered `imageUrl` or `logoUrl`.
